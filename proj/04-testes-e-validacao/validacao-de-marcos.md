<!-- proj/04-testes-e-validacao/validacao-de-marcos.md -->
# Validação de Marcos

## Propósito
Use este documento como modelo para registrar o requisito "Validação de Marcos" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`validacao-de-marcos-spec.md`).
...
## Documento evolutivo
[Validação de Marcos — Especificação Evolutiva](./validacao-de-marcos-spec.md)
