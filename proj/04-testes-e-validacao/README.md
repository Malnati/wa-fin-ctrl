<!-- proj/04-testes-e-validacao/README.md -->
# Testes e Validação

## Propósito
Use este documento como modelo para registrar o requisito "Testes e Validação" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Testes e Validação — Especificação Evolutiva](./README-spec.md)
