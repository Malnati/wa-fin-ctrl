...
## Propósito
Use este documento como modelo para registrar o requisito "Construção (arquivo histórico)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Construção (arquivo histórico) — Especificação Evolutiva](./README-spec.md)
