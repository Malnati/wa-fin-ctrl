...
## Propósito
Use este documento como modelo para registrar o requisito "Padrões de Código e Convenções" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`padroes-de-codigo-spec.md`).
...
## Documento evolutivo
[Padrões de Código e Convenções — Especificação Evolutiva](./padroes-de-codigo-spec.md)
