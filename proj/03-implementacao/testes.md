...
## Propósito
Use este documento como modelo para registrar o requisito "Estratégia de Testes na Implementação" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`testes-spec.md`).
...
## Documento evolutivo
[Estratégia de Testes na Implementação — Especificação Evolutiva](./testes-spec.md)
