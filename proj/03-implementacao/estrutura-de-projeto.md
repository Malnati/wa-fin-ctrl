...
## Propósito
Use este documento como modelo para registrar o requisito "Estrutura de Projeto" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`estrutura-de-projeto-spec.md`).
...
## Documento evolutivo
[Estrutura de Projeto — Especificação Evolutiva](./estrutura-de-projeto-spec.md)
