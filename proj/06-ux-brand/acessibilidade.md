<!-- proj/06-ux-brand/acessibilidade.md -->
# Acessibilidade

## Propósito
Use este documento como modelo para registrar o requisito "Acessibilidade" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`acessibilidade-spec.md`).
...
## Documento evolutivo
[Acessibilidade — Especificação Evolutiva](./acessibilidade-spec.md)
