...
## Propósito
Use este documento como modelo para registrar o requisito "Diretrizes de UX" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`diretrizes-de-ux-spec.md`).
...
## Documento evolutivo
[Diretrizes de UX — Especificação Evolutiva](./diretrizes-de-ux-spec.md)
