<!-- proj/02-planejamento/riscos-e-mitigacoes.md -->
# Riscos e Mitigações

## Propósito
Use este documento como modelo para registrar o requisito "Riscos e Mitigações" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`riscos-e-mitigacoes-spec.md`).
...
## Documento evolutivo
[Riscos e Mitigações — Especificação Evolutiva](./riscos-e-mitigacoes-spec.md)
