...
## Propósito
Use este documento como modelo para registrar o requisito "Work Breakdown Structure (WBS)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`wbs-spec.md`).
...
## Documento evolutivo
[Work Breakdown Structure (WBS) — Especificação Evolutiva](./wbs-spec.md)
