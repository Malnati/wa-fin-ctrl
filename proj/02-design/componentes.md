...
## Propósito
Use este documento como modelo para registrar o requisito "Componentes do Sistema" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`componentes-spec.md`).
...
## Documento evolutivo
[Componentes do Sistema — Especificação Evolutiva](./componentes-spec.md)
