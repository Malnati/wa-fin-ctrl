...
## Propósito
Use este documento como modelo para registrar o requisito "Fluxos de Interação entre Componentes" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`fluxos-spec.md`).
...
## Documento evolutivo
[Fluxos de Interação entre Componentes — Especificação Evolutiva](./fluxos-spec.md)
