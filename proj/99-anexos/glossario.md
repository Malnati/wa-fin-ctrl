<!-- proj/99-anexos/glossario.md -->
# Glossário

## Propósito
Use este documento como modelo para registrar o requisito "Glossário" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`glossario-spec.md`).
...
## Documento evolutivo
[Glossário — Especificação Evolutiva](./glossario-spec.md)
