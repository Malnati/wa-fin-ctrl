<!-- proj/99-anexos/referencias.md -->
# Referências

## Propósito
Use este documento como modelo para registrar o requisito "Referências" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`referencias-spec.md`).
...
## Documento evolutivo
[Referências — Especificação Evolutiva](./referencias-spec.md)
