...
## Propósito
Use este documento como modelo para registrar o requisito "Empacotamento e Build Final" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`empacotamento-spec.md`).
...
## Documento evolutivo
[Empacotamento e Build Final — Especificação Evolutiva](./empacotamento-spec.md)
