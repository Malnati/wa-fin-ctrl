...
## Propósito
Use este documento como modelo para registrar o requisito "Ambientes e Configurações" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`ambientes-e-configuracoes-spec.md`).
...
## Documento evolutivo
[Ambientes e Configurações — Especificação Evolutiva](./ambientes-e-configuracoes-spec.md)
