...
## Propósito
Use este documento como modelo para registrar o requisito "Integrações com APIs" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`integracoes-com-apis-spec.md`).
...
## Documento evolutivo
[Integrações com APIs — Especificação Evolutiva](./integracoes-com-apis-spec.md)
