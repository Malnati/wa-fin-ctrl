...
## Propósito
Use este documento como modelo para registrar o requisito "Requisitos Não Funcionais" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`requisitos-nao-funcionais-spec.md`).
...
## Documento evolutivo
[Requisitos Não Funcionais — Especificação Evolutiva](./requisitos-nao-funcionais-spec.md)
