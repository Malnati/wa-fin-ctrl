...
## Propósito
Use este documento como modelo para registrar o requisito "Critérios de Aceite" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`criterios-de-aceite-spec.md`).
...
## Documento evolutivo
[Critérios de Aceite — Especificação Evolutiva](./criterios-de-aceite-spec.md)
