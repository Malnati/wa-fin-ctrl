...
## Propósito
Use este documento como modelo para registrar o requisito "Qualidade e Testes (arquivo)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Qualidade e Testes (arquivo) — Especificação Evolutiva](./README-spec.md)
