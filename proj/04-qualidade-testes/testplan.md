...
## Propósito
Use este documento como modelo para registrar o requisito "TestPlan" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`testplan-spec.md`).
...
## Documento evolutivo
[TestPlan — Especificação Evolutiva](./testplan-spec.md)
