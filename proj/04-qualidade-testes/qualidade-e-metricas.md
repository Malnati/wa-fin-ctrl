...
## Propósito
Use este documento como modelo para registrar o requisito "Qualidade e Métricas" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`qualidade-e-metricas-spec.md`).
...
## Documento evolutivo
[Qualidade e Métricas — Especificação Evolutiva](./qualidade-e-metricas-spec.md)
