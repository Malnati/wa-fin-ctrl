...
## Propósito
Use este documento como modelo para registrar o requisito "Operação e Release (arquivo)" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.
...
## Documento evolutivo
[Operação e Release (arquivo) — Especificação Evolutiva](./README-spec.md)
