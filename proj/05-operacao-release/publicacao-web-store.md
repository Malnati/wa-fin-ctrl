...
## Propósito
Use este documento como modelo para registrar o requisito "Publicação Web Store" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`publicacao-web-store-spec.md`).
...
## Documento evolutivo
[Publicação Web Store — Especificação Evolutiva](./publicacao-web-store-spec.md)
