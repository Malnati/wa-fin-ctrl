...
## Propósito
Use este documento como modelo para registrar o requisito "Versão e Changelog" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`versao-e-changelog-spec.md`).
...
## Documento evolutivo
[Versão e Changelog — Especificação Evolutiva](./versao-e-changelog-spec.md)
