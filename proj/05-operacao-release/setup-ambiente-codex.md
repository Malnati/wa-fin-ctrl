...
## Propósito
Use este documento como modelo para registrar o requisito "Setup do ambiente Codex" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`setup-ambiente-codex-spec.md`).
...
## Documento evolutivo
[Setup do ambiente Codex — Especificação Evolutiva](./setup-ambiente-codex-spec.md)
