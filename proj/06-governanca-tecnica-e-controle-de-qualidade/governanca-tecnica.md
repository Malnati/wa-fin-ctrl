<!-- proj/06-governanca-tecnica-e-controle-de-qualidade/governanca-tecnica.md -->
# Governança Técnica

## Propósito
Use este documento como modelo para registrar o requisito "Governança Técnica" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`governanca-tecnica-spec.md`).
...
## Documento evolutivo
[Governança Técnica — Especificação Evolutiva](./governanca-tecnica-spec.md)
