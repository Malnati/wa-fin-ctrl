<!-- proj/07-contribuicao/template-de-pr.md -->
# Template de PR

## Propósito
Use este documento como modelo para registrar o requisito "Template de PR" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`template-de-pr-spec.md`).
...
## Documento evolutivo
[Template de PR — Especificação Evolutiva](./template-de-pr-spec.md)
