...
## Propósito
Use este documento como modelo para registrar o requisito "Escopo" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`escopo-spec.md`).
...
## Documento evolutivo
[Escopo — Especificação Evolutiva](./escopo-spec.md)
