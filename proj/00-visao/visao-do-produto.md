...
## Propósito
Use este documento como modelo para registrar o requisito "Visão do Produto" em novos projetos. Ele explica o objetivo do artefato, indica como interpretá-lo e orienta o time sobre quando consultar o material evolutivo.

## Como usar
1. Leia o documento evolutivo correspondente para acompanhar as decisões vigentes (`visao-do-produto-spec.md`).
...
## Documento evolutivo
[Visão do Produto — Especificação Evolutiva](./visao-do-produto-spec.md)
