...
def main():
    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            if (pd.isna(ocr) or ocr == '' or ocr == 'nan') and anexo not in ocr_processed:
        ...
        if imagens_sem_texto:
            print(f"⚠️  Aviso: {len(imagens_sem_texto)} imagens foram processadas mas não têm texto legível:")
